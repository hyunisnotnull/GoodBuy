...
CREATE TABLE TBL_USER(
	...
	U_ACTIVE				TINYINT DEFAULT 2,					-- 0(삭제된 계정), 1(정지된 계정), 2(활동중인 계정)
	U_CLASS					TINYINT DEFAULT 2,					-- 1(IRON), 2(BRONZE), 3(SILVER), 4(GOLD), 5(PLATINUM), 6(DIAMOND)
...
CREATE TABLE TBL_ADMIN(
	...
	A_ROLE					VARCHAR(20) DEFAULT 'PRE_ADMIN',		-- 1(PRE_ADMIN), 2(ADMIN)
...
CREATE TABLE TBL_CLASS(
	...
	CL_NAME					VARCHAR(20),						-- 1(IRON), 2(BRONZE), 3(SILVER), 4(GOLD), 5(PLATINUM), 6(DIAMOND)
	PRIMARY KEY(CL_NO)
);
...
INSERT INTO TBL_CATEGORY VALUES(0,'수입명품');
