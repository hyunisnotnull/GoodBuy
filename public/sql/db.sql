...
DESC TBL_PRODUCT;
SELECT * FROM TBL_PRODUCT WHERE P_NAME LIKE '노트%';
...
SELECT AU_PRODUCT_NO, AU_BUYER_ID FROM TBL_AUCTION WHERE AU_TRADE_DATE < NOW() AND AU_BUYER_ID IS NOT NULL
UNION
SELECT AU_PRODUCT_NO, AU_BUYER_ID  FROM TBL_AUCTION WHERE AU_TRADE_DATE < NOW() AND AU_BUYER_ID IS NULL;
